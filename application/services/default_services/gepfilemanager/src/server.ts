...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_tcejorpnahsikc_8186;
            let db_auth = result.data.DB_AUTH_tcejorpnahsikc_8186;
            let db_coll = result.data.DB_COLL_tcejorpnahsikc_8186;
